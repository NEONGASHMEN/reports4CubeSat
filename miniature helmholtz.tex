...
$$B \left(\frac{R}{2}) = 2B_1 \left(\frac{R}{2})\right)
$$=\frac{2\mu nI R^{2}{2(\left(R^{2} + (\left(\frac{R}{2} \right))^{2}\right))^{\frac{3}{2}}}
$$=\frac{\mu nI R^{2}}{(\left(R^{2} + (\left(\frac{R}{2} \right))^{2}\right))^{\frac{3}{2}}}
$$=\frac{\mu nI R^{2}}{(\left(R^{2} + \frac{1}{4}R^{2}\right))^{\frac{3}{2}}}
$$=\frac{\mu nI R^{2}}{(\left(\frac{5}{4}R^{2}\right))^{\frac{3}{2}}}
$$=(\frac{4}{5})^{\frac{3}{2}\frac{\mu_0 NI}{R}
$$=\frac{8}{5\sqrt{5}}\frac{\mu_0 NI}{R}

            Where n=number of turns
            I= current(measured using multimeter)
